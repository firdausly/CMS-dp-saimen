...
public class AcquaintanceIterator extends
AcquaintanceComponent implements Iterator {
 Iterator ec;
 String acquaintanceName;
 int acquaintanceType;
 Acquaintances nextAcquaintances;
public AcquaintanceIterator(ArrayList<Acquaintances> ec,
String acquaintanceName, int acquaintanceType) {
 this.ec = ec.iterator();
 ...
 if
(tempObj.getName().equalsIgnoreCase(acquaintanceName))
{
 matchFound = true;
